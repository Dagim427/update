...
function ViewDoctorEvaluationById() {
  ...
  useEffect(() => {
    async function fetchPatient() {
      try {
        const res = await axios.get(`/doctor/doctor-evaluation/${id}/view`);
            ...
            <div className="form-container">
              ...
              <form>
                <fieldset className="border rounded-3 p-4 mb-4 shadow-sm bg-light">
                  ...
                  <div className="row mb-2">
                    <label className="col-sm-3 fw-bold">Pain scale</label>
                    <div className="col-sm-9">{patient.pain_scale}</div>
                  </div>
                  <div className="row mb-2">
                    <label className="col-sm-3 fw-bold">hpi</label>
                    <div className="col-sm-9">{patient.hpi}</div>
                  </div>
                  <div className="row mb-2">
                    <label className="col-sm-3 fw-bold">Physical exam</label>
                    <div className="col-sm-9">{patient.physical_exam}</div>
                  </div>
                  <div className="row mb-2">
...
export default ViewDoctorEvaluationById;
