...
const LabTechnicianSidebar = ({ isMobileNavVisible, toggleMobileNav }) => {
  ...
  return (
    <div className={`dashboard-nav ${isMobileNavVisible ? "mobile-show" : ""}`}>
      ...
      <nav className="dashboard-nav-list">
        ...
        <Link to="/lab-technician" className="dashboard-nav-item text-decoration-none ">
          Dashboard
        </Link>
        <button
        ...
        >
          Lab Request <i className="bi bi-caret-down-fill ms-2"></i>
        </button>
        {isOpen && (
          <div>
            <Link
              to="/lab-technician/view-lab-request"
